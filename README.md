...
If you don't know how to create the screen shader itself, a good tutorial can be found [here](https://www.alanzucconi.com/2015/07/08/screen-shaders-and-postprocessing-effects-in-unity3d/) (**only** follow Step 1 by copying the shader code they provide into a new shader file, as Step 2 is invalidated by my script).
